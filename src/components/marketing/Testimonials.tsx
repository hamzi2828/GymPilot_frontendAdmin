          ...
          {TESTIMONIALS.map((t, i) => (
            <Reveal key={t.quote} delay={i * 100} as="li">
              <figure className="flex h-full flex-col rounded-2xl border border-slate-200 bg-slate-50 p-7">
                <span className="font-display text-5xl leading-none text-brand-300" aria-hidden="true">
                  “
                </span>
                <blockquote className="mt-2 flex-1 text-base leading-relaxed text-slate-800">{t.quote}</blockquote>
